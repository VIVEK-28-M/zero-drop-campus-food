...
export const ITEMS: Item[] = [
  { id: "i1", vendorId: "v1", name: "Masala Dosa", description: "Crisp golden dosa with spiced potato filling, coconut chutney & sambar. Made fresh for the dinner rush.", tags: ["Veg"], image: imgDosa, basePrice: 60, floorPrice: 42, listedAt: NOW - 42 * MIN, closesAt: NOW + 78 * MIN, stepMs: std, preset: "standard", quantity: 14, sold: 6 },
  { id: "i2", vendorId: "v2", name: "Chicken Biryani Bowl", description: "Dum-style biryani with tender chicken, mint raita and fried onions. Surplus from the lunch batch.", tags: ["Non-Veg"], image: imgBiryani, basePrice: 120, floorPrice: 84, listedAt: NOW - 55 * MIN, closesAt: NOW + 50 * MIN, stepMs: agg, preset: "aggressive", quantity: 8, sold: 11 },
  { id: "i3", vendorId: "v3", name: "Paneer Kathi Roll", description: "Flaky paratha wrap stuffed with smoky paneer tikka, onions and mint chutney.", tags: ["Veg"], image: imgRoll, basePrice: 80, floorPrice: 56, listedAt: NOW - 30 * MIN, closesAt: NOW + 120 * MIN, stepMs: std, preset: "standard", quantity: 11, sold: 4 },
  { id: "i4", vendorId: "v4", name: "Veg Thali (Jain option)", description: "Full mess thali: dal, seasonal sabzi, paneer curry, rice, 2 rotis, salad & papad. Jain prep available.", tags: ["Veg", "Jain"], image: imgThali, basePrice: 90, floorPrice: 63, listedAt: NOW - 70 * MIN, closesAt: NOW + 95 * MIN, stepMs: std, preset: "standard", quantity: 20, sold: 9 },
  { id: "i5", vendorId: "v5", name: "Samosa (4 pc)", description: "Flaky samosas with tangy tamarind & green chutneys. End-of-day bakery clearance.", tags: ["Veg", "Bakery"], image: imgSamosa, basePrice: 40, floorPrice: 28, listedAt: NOW - 48 * MIN, closesAt: NOW + 42 * MIN, stepMs: agg, preset: "aggressive", quantity: 26, sold: 14 },
  { id: "i6", vendorId: "v6", name: "Cold Coffee 300ml", description: "Slow-brewed cold coffee with cream swirl. Batch brewed at 4 PM, must go tonight.", tags: ["Beverage", "Veg"], image: imgCoffee, basePrice: 70, floorPrice: 49, listedAt: NOW - 35 * MIN, closesAt: NOW + 135 * MIN, stepMs: std, preset: "standard", quantity: 9, sold: 7 },
  { id: "i7", vendorId: "v7", name: "Veg Hakka Noodles", description: "Wok-tossed noodles with crunchy vegetables and burnt garlic. Prepared for the evening crowd.", tags: ["Veg"], image: imgNoodles, basePrice: 75, floorPrice: 52, listedAt: NOW - 52 * MIN, closesAt: NOW + 58 * MIN, stepMs: agg, preset: "aggressive", quantity: 12, sold: 5 },
  { id: "i8", vendorId: "v5", name: "Grilled Cheese Sandwich", description: "Triple-layer grilled sandwich with cheese, tomato, cucumber & mint mayo.", tags: ["Veg", "Bakery"], image: imgSandwich, basePrice: 55, floorPrice: 39, listedAt: NOW - 25 * MIN, closesAt: NOW + 100 * MIN, stepMs: std, preset: "standard", quantity: 15, sold: 3 },
  { id: "i9", vendorId: "v8", name: "Fruit Chaat Bowl", description: "Seasonal fruit bowl with chaat masala — mango, apple, pomegranate & mint.", tags: ["Vegan", "Veg"], image: imgFruit, basePrice: 50, floorPrice: 35, listedAt: NOW - 40 * MIN, closesAt: NOW + 45 * MIN, stepMs: agg, preset: "aggressive", quantity: 7, sold: 6 },
  { id: "i10", vendorId: "v7", name: "Egg Fried Rice", description: "Smoky wok fried rice with scrambled egg and spring onions.", tags: ["Non-Veg"], image: imgRice, basePrice: 85, floorPrice: 60, listedAt: NOW - 60 * MIN, closesAt: NOW + 110 * MIN, stepMs: std, preset: "standard", quantity: 10, sold: 8 },
];
